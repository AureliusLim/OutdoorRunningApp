...
class ProgressActivity: AppCompatActivity(), SelectListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.workoutDuration.text = "Duration \n\n" + workoutList[2].duration.toString()
        this.workoutCalories.text = "Calories \n\n" + workoutList[2].calories.toString()
        this.workoutHeart.text = "Heart Rate \n\n" + workoutList[2].heartRate.toString()
        this.workoutDistance.text = workoutList[2].distance.toString() + "km"
        this.workoutSpeed.text = "Avg Speed \n\n" + workoutList[2].avgSpeed.toString()
        this.actualDate.text = workoutList[2].actualdate
